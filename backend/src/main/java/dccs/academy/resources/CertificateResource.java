...
public class CertificateResource {
  ...
  public Response getAllCertificates() {
    try {
      ...
      return ResponseUtility.successResponse(
          "Certificates retrieved successfully", certificates, Response.Status.OK);
    } catch (Exception e) {
  ...
  public Response getCertificateById(@PathParam("id") Long id) {
    try {
      ...
      return ResponseUtility.successResponse(
          "Certificate retrieved successfully", certificate, Response.Status.OK);
  ...
  public Response createCertificate(CertificateDto certificateDto) {
    try {
      ...
      return ResponseUtility.successResponse(
          "Certificate created successfully", createdCertificate, Response.Status.CREATED);
    } catch (EntityNotFoundException e) {
      return ResponseUtility.errorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
      return ResponseUtility.errorResponse(e.getMessage(), Response.Status.INTERNAL_SERVER_ERROR);
  ...
  public Response deleteCertificate(@PathParam("id") Long id) {
    try {
      ...
      return ResponseUtility.successResponse(
          "Certificate with ID " + id + " is deleted successfully", null, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseUtility.errorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
      return ResponseUtility.errorResponse(e.getMessage(), Response.Status.INTERNAL_SERVER_ERROR);
